...
class SimpleRenameTool extends EditorWindow {
	...
	var _alphabetSort:boolean;
	var _hierarchySort:boolean;
	var _content:GUIContent = new GUIContent();
	@MenuItem("Window/SimpleRenameTool")
	static

	function ShowWindow() {
			var win = EditorWindow.GetWindow(SimpleRenameTool);
			win.minSize = new Vector2(250, 430);
	...
	static function Compare (g1 : Transform, g2 : Transform) {
    	return g1.name.CompareTo (g2.name);
    }
    
	static function Compare (first : float, second : float){
		var result : float = 0;
